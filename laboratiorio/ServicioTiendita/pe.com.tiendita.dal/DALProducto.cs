    ...
    public class DALProducto
    {
        ...
        public List<BOProducto> MostrarProductoTodo()
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    BOCategoria objpro = new BOCategoria();
                    objpro.codigo = Convert.ToInt32(dr["codcat"].ToString());
                    objpro nombre = dr["nomcat"].ToString();
                    objpro.estado = Convert.ToBoolean(dr["estcat"].ToString());
                    lista.Add(objpro);
                }
                return lista;
            }
